...
<script>
var webSocket
    = new WebSocket("<%= application.getInitParameter("CHAT_ADDR") %>/GameChatingServer");
...
webSocket.onmessage = function(event) { 
    ...
    var roomNum = message[0];
    var sender = message[1];   // 보낸 사람의 대화명
    var content = message[2];  // 메시지 내용
    if(chatRoomNum == roomNum){
	    if (content != "") {
